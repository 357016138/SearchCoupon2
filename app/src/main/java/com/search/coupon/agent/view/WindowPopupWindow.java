...
public class WindowPopupWindow extends android.widget.PopupWindow {

    private Context mContext;
    private float mShowAlpha = 0.88f;
    private Drawable mBackgroundDrawable;
    private View arguContent;//将CcontentView提供给外部，便于外部的灵活操作;

    public WindowPopupWindow(Context context) {
