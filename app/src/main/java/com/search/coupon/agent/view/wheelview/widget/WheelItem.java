 ...
 */
package com.search.coupon.agent.view.wheelview.widget;
...
import com.search.coupon.agent.view.wheelview.common.WheelConstants;
import com.search.coupon.agent.view.wheelview.util.WheelUtils;
...
public class WheelItem extends FrameLayout {
    ...
    private void init() {
        ...
        mText.setTextColor(getContext().getResources().getColor(R.color.color_374953));
        LayoutParams textParams = new LayoutParams(LayoutParams.MATCH_PARENT, UtilTools.dp2px(getContext(),50));
