...
public class Luban implements Handler.Callback {
     ...
     *     A context.
     */
    private String getImageCacheFile(Context context, String suffix) {
    ...
    private File getImageCacheDir(Context context, String cacheName) {
        ...
        JYLogUtils.e(TAG, "default disk cache dir is null");
        return null;
    }
                ...
                AsyncTask.SERIAL_EXECUTOR.execute(new Runnable() {
                  ...
                  public void run() {
                    try {
                        ...
                        String result = Checker.isNeedCompress(mLeastCompressSize, path) ?
     ...
     */
    @WorkerThread
    private String get(String path, Context context) throws IOException {
        return new Engine(path, getImageCacheFile(context, Checker.checkSuffix(path))).compress();
    }

    @WorkerThread
    private ArrayList<String> get(Context context) throws IOException {
    ...
    public static class Builder {
        ...
        public Builder load(ArrayList<String> list) {
