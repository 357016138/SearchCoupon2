...
public class ProvinceArrayWheelAdapter<T> extends BaseWheelAdapter<T> {

    private Context mContext;

    public ProvinceArrayWheelAdapter(Context context) {
        mContext = context;
    }
    ...
    public View bindView(int position, View convertView, ViewGroup parent) {
        ...
        if (wheelItem instanceof CharSequence) {
            ...
            ProvinceBean bean =(ProvinceBean)item;
